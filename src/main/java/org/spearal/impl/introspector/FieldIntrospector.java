...
public class FieldIntrospector implements Introspector {
	...
	private static Logger logger = Logger.getLogger(FieldIntrospector.class.getName());
	...
	public Collection<Property> getProperties(SpearalContext context, Class<?> cls) {
		...
		if (properties == null) {
			properties = introspectProperties(context, cls);
	...
	protected Collection<Property> introspectProperties(SpearalContext context, Class<?> cls) {

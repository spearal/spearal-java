...
public class CharConverter implements Converter {
	...
	public boolean canConvert(Class<?> cls, Type target) {
		return (target == Character.class || target == char.class);
	}

	@Override
	public Object convert(Object o, Type target) {
		if (o == null)
			return (target == char.class ? Character.valueOf('\0') : null);
		...
		if (cls == Boolean.class)
			return (((Boolean)o).booleanValue() ? Character.valueOf('\1') : Character.valueOf('\0'));

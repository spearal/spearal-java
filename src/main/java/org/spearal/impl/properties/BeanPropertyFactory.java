 ...
 * @author Franck WOLFF
 */
public class BeanPropertyFactory implements PropertyFactory, ObjectWriterProvider {

	@Override
	public ObjectWriter getWriter(Class<?> type) {
		return (BeanProperty.canCreateWriter(type) ? BeanProperty.createWriter() : null);
	}

	@Override
	public boolean canCreateProperty(Class<?> type) {
		return BeanProperty.canCreateProperty(type);
	}

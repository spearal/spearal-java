 ...
 * @author Franck WOLFF
 */
public class SqlTimestampProperty extends AbstractNonPrimitiveProperty {
	...
	public static ObjectWriter createWriter() {
		return new ObjectWriter() {
			...
			public void write(ExtendedSpearalEncoder out, Object o) throws IOException {
				out.writeDateTime(SpearalDateTime.forSQLTimestamp((Timestamp)o));
			}
		};
	}
	...
	public SqlTimestampProperty(String name, Field field, Method getter, Method setter) {
	...
	protected boolean readObjectField(int parameterizedType, ExtendedSpearalDecoder in, Object obj, Field field)
		...
		case DATE_TIME:
			field.set(obj, in.readDateTime(parameterizedType).toSQLTimestamp());
			return true;
	...
	protected boolean readObjectMethod(int parameterizedType, ExtendedSpearalDecoder in, Object obj, Method setter)
		...
		case DATE_TIME:
			setter.invoke(obj, in.readDateTime(parameterizedType).toSQLTimestamp());
			return true;
	...
	private static void writeTimestamp(ExtendedSpearalEncoder out, Timestamp value) throws IOException {
		if (value == null)
			...
			out.writeDateTime(SpearalDateTime.forSQLTimestamp(value));
	}
}

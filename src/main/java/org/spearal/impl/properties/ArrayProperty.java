 ...
 * @author Franck WOLFF
 */
public class ArrayProperty extends AbstractNonPrimitiveProperty {
	...
	public static boolean canCreateProperty(Class<?> type) {
		return type != byte[].class && type.isArray();
	}

	public ArrayProperty(String name, Field field, Method getter, Method setter) {
	...
	protected void writeObjectMethod(ExtendedSpearalEncoder out, Object obj, Method getter)
		...
		writeArray(out, getter.invoke(obj));
	}
	...
	protected boolean readObjectField(int parameterizedType, ExtendedSpearalDecoder in, Object obj, Field field)
		...
		case COLLECTION:
			field.set(obj, in.getContext().convert(in.readCollection(parameterizedType), getGenericType()));
			return true;
	...
	protected boolean readObjectMethod(int parameterizedType, ExtendedSpearalDecoder in, Object obj, Method setter)
		...
		case COLLECTION:
			setter.invoke(obj, in.getContext().convert(in.readCollection(parameterizedType), getGenericType()));
			return true;
	...
	private static void writeArray(ExtendedSpearalEncoder out, Object value)
		throws IOException {

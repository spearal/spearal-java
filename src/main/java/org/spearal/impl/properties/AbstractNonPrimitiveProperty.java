 ...
 * @author Franck WOLFF
 */
public abstract class AbstractNonPrimitiveProperty extends AbstractProperty {

	public AbstractNonPrimitiveProperty(String name, Field field, Method getter, Method setter) {
